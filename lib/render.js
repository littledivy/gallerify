...
var startViewInit = (outDir) => {
    ...
    for (var x = 0; x < imgSource.length; x++) {
        data += ` <li class="col-xs-4 col-sm-1 col-md-3" data-responsive="images/${imgSource[x]}" data-src="images/${imgSource[x]}" data-sub-html="<h4>${imgSource[x]}</h4><p>Image index ${x}</p>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1"><center><img src="images/${imgSource[x]}" class="img-thumbnail" alt=""></center></li>`;
    }
